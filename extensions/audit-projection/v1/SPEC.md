# ACAP Audit-Projection Extension — Wire Specification

> Generated from `v1/manifest.json`. Re-render after the manifest changes; do not hand-edit.

- **Extension URI:** `https://ravikiran438.github.io/agent-consent-protocol/extensions/audit-projection/v1`
- **Protocol version:** 1.0.0
- **Manifest envelope version:** 1.0.0
- **Publisher:** Ravi Kiran Kadaboina

Compact projections of ACAP consent + adherence chains for auditors.
...
- Projections MUST preserve the cryptographic anchor of the source chain.
